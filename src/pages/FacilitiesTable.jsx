        ...
        <div className="flex flex-col mt-6">
            <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8 space-y-10">
                    <h1 className='text-3xl md:text-5xl text-grayText font-bold text-center md:text-left'>All Facilities</h1>
                        ...
                        <table className="min-w-full divide-y divide-primary">
                            <thead className="bg-secondary">
                                <tr>
                                    ...
                                    <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-grayText">Location</th>
                            ...
                            <tbody className="bg-secondary divide-y divide-primary">
                                {facilities?.data?.filter(facility => facility?.isDeleted === false)?.map((facility) => (
                                    <tr key={facility._id}>
                                        ...
                                        <td className="px-4 py-4 text-sm text-grayText whitespace-nowrap">{facility?.pricePerHour}</td>
                                        <td className="px-4 py-4 text-sm text-grayText whitespace-nowrap">{facility?.location}</td>
