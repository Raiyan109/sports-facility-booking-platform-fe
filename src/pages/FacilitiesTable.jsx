...
import { useDeleteFacilityMutation, useGetFacilitiesQuery } from "../redux/features/facility/facilityApi"
                        ...
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead className="bg-gray-50 dark:bg-gray-800">
                                <tr>
                                    ...
                                    <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Edit</th>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                {facilities?.data?.filter(facility => facility?.isDeleted === false)?.map((facility) => (
                                    <tr key={facility._id}>
                                        <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div className="inline-flex items-center gap-x-3">
                                                ...
                                                <div className="flex items-center gap-x-2">
                                                    ...
                                                    <div>
                                                        <h2 className="font-medium text-gray-800 dark:text-white ">{facility?.name}</h2>
                                        ...
                                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{facility?.pricePerHour}</td>
                                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{facility?.location}</td>
